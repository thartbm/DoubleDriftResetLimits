...
Participants were to be made For reporting degrees of visual angle that stimuli spanned ( _dva_ ), we assume the participant is close to the setup, with their eyes at the height of the monitor. Since there was no requirement to use the forehead rest, the latter is probably only true for the tallest participants, so that reported _dva's_ are underestimating the size of stimuli.
