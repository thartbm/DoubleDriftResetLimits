...
#   
#   if (normalizeTime) {
#     df$boundY_mean[which(df$externalspeed == 3)] <- ( 3/4 ) * df$boundY_mean[which(df$externalspeed == 3)]
#     df$boundY_sd[which(df$externalspeed == 3)]   <- ( 3/4 ) * df$boundY_sd[which(df$externalspeed == 3)]
#   }
#   
