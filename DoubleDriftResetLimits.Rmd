...
Again, we see no time-dependent decrease of heading towards zero, except perhaps at the start of the data for participant 12. Since these are preceded by very large headings, and then settle into the normal range, this participant might have had more trouble responding to the direction reversals of the gabor. The group average reflects this tendency of participant 12 somewhat, but overall the average heading is very close to what was seen in the first trakcing experiment: 28.9 compared to 27.4 or 26.7 degrees.

# Experiment 2: one-pass tracking and psychophysics

Since it seemed that no clear spontaneous resets occurred in the continuous tracking paradigm, we used a re-tracing approach (c.f. @Nakayama2019). 