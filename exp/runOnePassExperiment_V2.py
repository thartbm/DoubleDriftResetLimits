...
TDtraceDelayed['taskname']                   = 're-trace'
...
for trialno in doTrials:
  ...
  trial_data = pd.DataFrame.from_csv('../data/onepass_V2/trials/onepass_V3_p%02d_t%03d.csv'%(cfg['id'], trialno+1), index_col=None)
...
participant_data.to_csv('../data/onepass_V2/onepass_V3_p%02d.csv'%(cfg['id']), index=False, float_format='%0.3f')
