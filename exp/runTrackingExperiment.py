...
for trialno in range(Ntrials):
  ...
  trial_data = pd.DataFrame.from_csv('../data/tracking_trials/tracking_p%02d_t%03d.csv'%(cfg['id'], trialno+1), index_col=None)
  ...
  participant_data.to_csv('../data/tracking_full/tracking_p%02d.csv'%(cfg['id']), index=False, float_format='%0.3f')
